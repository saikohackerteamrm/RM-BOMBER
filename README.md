...
# Author 
![Screenshot](https://github.com/Saikohackerteamrm/RM-BOMBER/blob/main/Admin.jpg)
...
____________________
    ...
    $ git clone https://github.com/saikohackerteamrm/RM-BOMBER
    $ cd RM-BOMBER
    $ python Saiko.py
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/saikohackerteamrm/RM-BOMBER && cd RM-BOMBER && python Saiko.py
 ### Hi there 👋
